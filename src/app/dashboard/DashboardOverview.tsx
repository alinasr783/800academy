    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white p-6 rounded-2xl border border-outline/30 shadow-sm">
        <div>
          ...
          <p className="text-on-surface-variant text-sm mt-1">Track key metrics and monitor platform growth</p>
        </div>
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
            <KpiCard title="Website Visitors" value={data.kpis.totalVisitors} icon="group" color="text-[#00D4FF]" bg="bg-[#00D4FF]/10" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white p-6 rounded-2xl border border-outline/30 shadow-sm">
              <h3 className="font-semibold text-lg mb-6">Top Geographic Locations</h3>
